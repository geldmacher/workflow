...
4. Provide the resume information in the native task: approved plan and assignment, completed work, actual repository state, checks and limitations, useful artifact locations, unresolved decisions, and the next action. Link existing reports instead of duplicating them where the receiver can access them.
