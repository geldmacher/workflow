...
Recheck affected behavior and report which findings were addressed, what changed, actual checks and results, and unresolved limitations on the current working state. Correction does not establish that a subsequent review passed. End with fresh Review pending; the human starts that review separately.
