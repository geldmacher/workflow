...
Treat invocation as human authorization for bounded project-guidance edits. Interpret all trailing text as one supplemental Learning, never an artifact ID. Resolve exactly one valid schema-3 root and linear review/evidence chain; stop before mutation on missing, ambiguous, schema-2, or mixed input.
