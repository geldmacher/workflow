...
Read the [working agreement](../../references/workflow.md). Resolve the approved plan and human implementation instruction, including any material amendments. Inspect the current repository before editing. If the handoff is incomplete or contradicts current work, clarify the specific consequential gap.
