...
Resolve the unique actionable correction and evidence tip. Reject invalid, ambiguous, schema-2, or mixed chains before mutation. Use the validator when available; otherwise check root, chain, scope, reuse, risk, and approval.
