...
test("release installation guide has usable selected-host verification and a complete Codex marketplace", () => {
  ...
  if (process.platform !== "win32") {
    ...
    try {
      const archive = "geldmacher-workflow-cursor-v6.2.0.zip";
      ...
      writeFileSync(join(download, "SHA256SUMS"), [
        ...
        `${"a".repeat(64)}  geldmacher-workflow-codex-v6.2.0.zip`,
      ...
      assert.match(result.stdout, /geldmacher-workflow-cursor-v6\.2\.0\.zip: OK/);
