...
6. Issue Capability Receipt Schema 3 with a capability vector and one explicit Qualification binding. Negative observations remain negative; never infer a capability.
