...
import { enumerateReleaseSurface, hashReleaseSurface, loadReleaseSurface, validateReleaseSurfaceClosure } from "./release-surface.mjs";
...
try {
  ...
  if (report.entryCount > 110) throw new Error(`release package has ${report.entryCount} files; maximum is 110`);
