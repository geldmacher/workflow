...
function normalizeDerivedFields(parsed) {
  ...
  if (fields.artifact === "work-plan") {
    if (!Array.isArray(fields.hard_triggers)) {
      fields.hard_triggers = [];
      normalizations.push("hard_triggers defaulted to empty");
    }
    if (!fields.assurance_override) {
      fields.assurance_override = "none";
      normalizations.push("assurance_override defaulted to none");
    }
