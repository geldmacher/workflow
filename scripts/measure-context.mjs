...
export const flowMatrix = Object.freeze({
  phase_flows: Object.freeze({
    ...
    plan_oneshot: Object.freeze(["commands/plan-work.md", "skills/work-planning/SKILL.md", "references/human-output-runtime-contract.md", "references/executable-contract.md", "references/plan-container-contract.md"]),
    plan_compact_full: Object.freeze(["commands/plan-work.md", "skills/work-planning/SKILL.md", "references/human-output-runtime-contract.md", "references/executable-contract.md", "references/plan-container-contract.md", "references/design-contract.md"]),
    review_base: Object.freeze(["commands/review-work.md", "skills/work-review/SKILL.md", "references/human-output-runtime-contract.md", "references/artifact-protocol.md", "references/review-contract.md"]),
    correction: Object.freeze(["commands/correct-work.md", "skills/work-execution/SKILL.md", "references/human-output-runtime-contract.md", "references/artifact-protocol.md", "references/correction-contract.md"]),
    learning: Object.freeze(["commands/learn-from-work.md", "skills/work-learning/SKILL.md", "references/human-output-runtime-contract.md", "references/artifact-protocol.md", "references/learning-contract.md"]),
    explanation: Object.freeze(["commands/explain-work.md", "skills/work-explanation/SKILL.md", "references/human-output-runtime-contract.md", "references/explanation-contract.md"]),
  }),
  automation_flows: Object.freeze({
    prepare_or_approve: Object.freeze(["commands/auto-work.md", "skills/work-automation/SKILL.md", "references/human-output-runtime-contract.md", "references/automation-preparation-contract.md"]),
    status: Object.freeze(["commands/work-status.md", "skills/work-automation/SKILL.md", "references/human-output-runtime-contract.md", "references/state-contract.md"]),
    watch: Object.freeze(["commands/work-watch.md", "skills/work-automation/SKILL.md", "references/human-output-runtime-contract.md", "references/state-contract.md"]),
    control: Object.freeze(["commands/work-control.md", "skills/work-automation/SKILL.md", "references/human-output-runtime-contract.md", "references/state-contract.md", "references/automation-contract.md"]),
    models: Object.freeze(["commands/work-models.md", "skills/work-automation/SKILL.md", "references/human-output-runtime-contract.md", "references/model-routing-contract.md"]),
    verification: Object.freeze(["commands/work-verification.md", "skills/work-automation/SKILL.md", "references/human-output-runtime-contract.md", "references/verification-profile-contract.md"]),
    acceptance: Object.freeze(["commands/accept-work.md", "skills/work-automation/SKILL.md", "references/human-output-runtime-contract.md", "references/state-contract.md"]),
  }),
});
