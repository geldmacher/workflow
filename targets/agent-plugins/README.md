...
The human separately authorizes planning, implementation, correction, review, provisional acceptance, and learning. Planning and implementation use an exact Schema-6 Root. Every other artifact schema is unsupported.
