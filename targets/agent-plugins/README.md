...
The shared `install-release` skill supports Workflow release installation for Cursor and Codex only. In another harness it explains those supported targets and requires an explicit supported target before installation. See the [installation guide](../../docs/installation.md#install-from-your-harness).
