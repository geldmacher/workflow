...
Read [portable Manual boundaries](../../references/portable-manual.md) and the [project verification contract](../../../../references/verification-work-contract.md) completely. For Create or Maintenance also read the [project verifier template](../../../../references/project-verifier-template.md).
